 ...
 **    $Id: eval_residual.c 1407 2011-05-16 16:40:39Z luw $    **
******************************************************************************/
 ...
 *                       Jerzy Bernholc
 * FUNCTION
 *   void eval_residual( rmg_float_t *mat, rmg_float_t *f_mat, int dimx, int dimy, int dimz, 
                    ...
                    rmg_double_t gridhx, rmg_double_t gridhy, rmg_double_t gridhz, rmg_float_t * res)
{
    ...
    for (idx = 0; idx < size; idx++)
        res[idx] = 0.0;
    app_del2c_f (mat, res, dimx, dimy, dimz, gridhx, gridhy, gridhz);
