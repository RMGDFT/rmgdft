 ...
 *                       Jerzy Bernholc
 * FUNCTION
 *   void mg_restrict(rmg_double_t *full, REAL *half, int dimx, int dimy, int dimz)
...
void mg_restrict_6 (rmg_double_t * full, REAL * half, int dimx, int dimy, int dimz, int grid_ratio)
{
