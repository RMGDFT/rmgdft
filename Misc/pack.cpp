...
template void pack_3d<double>(double *data, double *buf, struct pack_plan_3d *plan);
template void unpack_3d<double>(double *buf, double *data, struct pack_plan_3d *plan);
template void unpack_3d_permute1_1<double>(double *buf, double *data, struct pack_plan_3d *plan);
template void unpack_3d_permute1_2<double>(double *buf, double *data, struct pack_plan_3d *plan);
template void unpack_3d_permute1_n<double>(double *buf, double *data, struct pack_plan_3d *plan);
template void unpack_3d_permute2_1<double>(double *buf, double *data, struct pack_plan_3d *plan);
template void unpack_3d_permute2_2<double>(double *buf, double *data, struct pack_plan_3d *plan);
template void unpack_3d_permute2_n<double>(double *buf, double *data, struct pack_plan_3d *plan);

template void pack_3d<float>(float *data, float *buf, struct pack_plan_3d *plan);
template void unpack_3d<float>(float *buf, float *data, struct pack_plan_3d *plan);
template void unpack_3d_permute1_1<float>(float *buf, float *data, struct pack_plan_3d *plan);
template void unpack_3d_permute1_2<float>(float *buf, float *data, struct pack_plan_3d *plan);
template void unpack_3d_permute1_n<float>(float *buf, float *data, struct pack_plan_3d *plan);
template void unpack_3d_permute2_1<float>(float *buf, float *data, struct pack_plan_3d *plan);
template void unpack_3d_permute2_2<float>(float *buf, float *data, struct pack_plan_3d *plan);
template void unpack_3d_permute2_n<float>(float *buf, float *data, struct pack_plan_3d *plan);
