...
REAL app_cil1_ortho (REAL *a, REAL *b, int dimx, int dimy, int dimz,
                     REAL gridhx, REAL gridhy, REAL gridhz);
void app_nls (REAL * psiR, REAL * psiI, REAL * workR, REAL * workI, REAL *work2R, REAL *work2I, 
     REAL *sintR, REAL *sintI, int state, int kidx);
void app_nls_allstates (REAL * psiR, REAL * psiI, REAL * workR, REAL * workI, REAL *work2R, REAL *work2I, 
     REAL *Bns, REAL *BnsI, REAL *sintR, REAL *sintI, int kidx);
