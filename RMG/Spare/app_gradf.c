 ...
 **    $Id: app_gradf.c 1722 2012-05-07 19:38:37Z ebriggs $    **
******************************************************************************/
...
void app_gradf (REAL * rho, FP0_GRID * wx, FP0_GRID * wy, FP0_GRID * wz)
{
    ...
    ixs = (pct.peFPY0_GRID + 4) * (pct.peFPZ0_GRID + 4);
    iys = (pct.peFPZ0_GRID + 4);
    ...
    my_malloc (rptr, (pct.peFPX0_GRID + 4) * (pct.peFPY0_GRID + 4) * (pct.peFPZ0_GRID + 4), REAL);


    time1 = my_crtc ();
    trade_imagesx (rho, rptr, pct.peFPX0_GRID, pct.peFPY0_GRID, pct.peFPZ0_GRID, 2, CENTRAL_FD);
