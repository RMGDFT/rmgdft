 ...
 **    $Id: app10_del2f.c 1722 2012-05-07 19:38:37Z ebriggs $    **
******************************************************************************/
 ...
 * INPUTS
 *   S0_GRID *f:  real array of (pct.peFPX0_GRID+2) * (pct.peFPY0_GRID+2) * ((pct.peFPZ0_GRID+2)
 *   see main.h for defination of unions S0_GRID and P0_GRID
 * OUTPUT
 *   P0_GRID *work: real array of pct.peFPX0_GRID * pct.peFPY0_GRID * pct.peFPZ0_GRID
 * PARENTS
 *   get_ke.c xcgga.c
 * CHILDREN
 *   trade_image2.c
...
void app10_del2f (FS0_GRID * f, FP0_GRID * work)
{
    ...
    int ixs, iys;
    int ix1, iy1;
    ixs = (pct.peFPY0_GRID + 8) * (pct.peFPZ0_GRID + 8);
    iys = (pct.peFPZ0_GRID + 8);
    ix1 = pct.peFPY0_GRID * pct.peFPZ0_GRID;
    iy1 = pct.peFPZ0_GRID;


    my_malloc (dum2, (pct.peFPX0_GRID + 8) * (pct.peFPY0_GRID + 8) * (pct.peFPZ0_GRID + 8), REAL);

    trade_imagesx (f->s2, dum2, pct.peFPX0_GRID, pct.peFPY0_GRID, pct.peFPZ0_GRID, 4, CENTRAL_FD);
    ...
    for (ix = 4; ix < pct.peFPX0_GRID + 4; ix++)
    {

	    for (iy = 4; iy < pct.peFPY0_GRID + 4; iy++)
        {

            for (iz = 4; iz < pct.peFPZ0_GRID + 4; iz++)
            {
