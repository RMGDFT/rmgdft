...
// These routines require dimensions fixed at compile time for now
#ifdef FD_XSIZE

// Mixed precision versions
__global__ void app_cil_sixth_f_cuda_kernel(const float *psi, 
                                                float *b, 
                                                const int dimx,
                                                const int dimy,
                                                const int dimz,
                                                ...
                                                const double tcx)
{
    ...
    __shared__ float slice[FIXED_YDIM/4 + 4][FIXED_ZDIM/4 + 4];
...
__global__ void app_cir_sixth_f_cuda_kernel(const float *psi, 
                                                float *b, 
                                                const int dimx,
                                                const int dimy,
                                                const int dimz)
{
    ...
    __shared__ double c000, c100, c110, c200;
                                    ...
                                    cudaStream_t cstream)
{
  ...
  app_cil_sixth_f_cuda_kernel<<<Grid, Block, 0, cstream>>>(
                                                   psi,
                                                   b,
                                                   dimx,    
                                                   dimy,    
                                    ...
                                    cudaStream_t cstream)
{
  ...
  app_cir_sixth_f_cuda_kernel<<<Grid, Block, 0, cstream>>>(
                                                   psi,
                                                   b,
                                                   dimx,    
                                                   dimy,    
                                                ...
                                                const double tcx)
{
    ...
    __shared__ double slice[FIXED_YDIM/4 + 4][FIXED_ZDIM/4 + 4];
    double accp_b2, accp_b1, accp, accp_a1, accp_a2;
...
__global__ void app_cir_sixth_cuda_kernel(const double *psi, 
                                                double *b, 
                                                const int dimx,
                                                const int dimy,
                                                const int dimz)
                                    ...
                                    cudaStream_t cstream)
{
  ...
  app_cir_sixth_cuda_kernel<<<Grid, Block, 0, cstream>>>(
                                                   psi,
                                                   b,
                                                   dimx,    
                                                   dimy,    
