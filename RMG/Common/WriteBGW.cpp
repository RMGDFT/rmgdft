 ...
 **    $Id: write_restart.c 2476 2014-09-02 22:54:58Z ebriggs $    **
******************************************************************************/
...
template void WriteBGW (char *, double *, double *, double *, double *, Kpoint<double> **);
template void WriteBGW (char *, double *, double *, double *, double *, Kpoint<std::complex<double> > **);
...
//	fprintf(fhandle,"\n");
    ...
    printf ("write_bgw: writing took %.1f seconds \n", write_time);
