 ...
 **    $Id: init_nl_xyz.c 818 2007-07-02 22:24:01Z luw $    **
******************************************************************************/
...
void init_nl_xyz()
{
    int ion, idx, iloc, map;
    int ixstart, iystart, izstart;
    int *pvec, *dvec;
    int ii, jj, kk, iii, jjj, kkk, icount;
    int index_low[3], index_high[3];
    int *Aix, *Aiy, *Aiz;
    double *rtptr;
    SPECIES *sp;
    ION *iptr;
