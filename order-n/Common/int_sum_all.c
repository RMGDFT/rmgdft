 ...
 **    $Id: int_sum_all.c 587 2006-08-18 22:57:56Z miro $    **
******************************************************************************/
 
/****f* QMD-MGDFT/int_sum_all.c *****
 * NAME
...
int int_sum_all(int x)
{
    ...
    MPI_Allreduce(&inreg, &outreg, 1, MPI_INTEGER, MPI_SUM, MPI_COMM_WORLD);
