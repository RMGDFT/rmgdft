 ...
 **    $Id: allocate_psi.c 587 2006-08-18 22:57:56Z miro $    **
******************************************************************************/
...
void allocate_psi(STATE * states, STATE * states1)
{
    ...
    my_malloc_init( rptr, pct.psi_size, REAL );
    my_malloc_init( rptr1, pct.psi_size, REAL );
    my_malloc_init( rptr2, pct.psi_size, REAL );
