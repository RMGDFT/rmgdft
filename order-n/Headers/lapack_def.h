 ...
 **    $Id: lapack_def.h 587 2006-08-18 22:57:56Z miro $    **
******************************************************************************/
...
void dposv (CCHAR, int *, int *, double *, int *, double *, int *, int *);
...
void dposv_c (char *, int *, int *, double *, int *, double *, int *, int *);
void dsyev_c (char *, char *, int *, double *, int *, double *, double *,
              int *, int *);
void dgees_c_ (char *, char *, char *, int *, double *, int *, int *,
               double *, double *, double *, int *, double *, double *,
               double *, int *, int *);
void dsygst_c (int *, char *, int *, double *, int *, double *, int *l,
               int *);
void dtrtrs_c (char *, char *, char *, int *, int *, double *, int *,
               double *, int *, int *);
void dpotrf_c (char *, int *, double *, int *, int *);
void dpotri_c (char *, int *, double *, int *, int *);
