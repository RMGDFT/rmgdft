...
void ylmr2_x (double *r, double *ylm_x)
{
    ...
    for (l = 0; l < 25; l++)
    {
        ...
        else if (l == 16)
        {
            ...
            ylm_x[l] =
                c * 4.0 * rhat[0] * (rhat[0] * rhat[0] - pow (rhat[0], 4.0) - pow (rhat[1], 4.0) -
                                     pow (rhat[2], 4.0)) / rmod;
        }
        else if (l == 17)
        {
            ...
            ylm_x[l] =
                c * (-4.0 * rhat[0] * rhat[1] * rhat[2]) * (rhat[1] * rhat[1] -
                                                            rhat[2] * rhat[2]) / rmod;
        }
        else if (l == 18)
        {
        ...
        else if (l == 19)
        {
            ...
            ylm_x[l] =
                c * 4.0 * rhat[0] * (rhat[0] * rhat[0] - 3.0 * rhat[2] * rhat[2] -
                                     (pow (rhat[0], 4.0) - pow (rhat[1], 4.0) -
        ...
        else if (l == 23)
        {
            c = sqrt (9.0 * 5.0 / fourPI) * 7.0 / 2.0;
            ylm_x[l] =
                c * 2.0 * rhat[0] * rhat[1] * rhat[2] * (1.0 - 2.0 * rhat[0] * rhat[0] +
                                                         1.0 / 7.0) / rmod;
        }
        else if (l == 24)
        {
            ...
            ylm_x[l] =
                c * rhat[0] * (-4.0 * pow (rhat[2], 4.0) -
                               2.0 * (rhat[0] * rhat[0] - pow (rhat[0], 4.0) - pow (rhat[1], 4.0)) -
                               6.0 / 7.0 * (-2.0 * rhat[2] * rhat[2] - 1.0 + rhat[0] * rhat[0] +
                                            rhat[1] * rhat[1])) / rmod;
        }
        else
