...
void matrix_inverse_rowcol (complex double * H_tri_host, int iprobe, complex double *G_tri_host, complex double *G_row_host, 
complex double *G_col_host)
{
 ...
 */
    ...
    complex double *Gii_host, *Grow, *Gcol;
    ...
    getvector_device_host (ncopy, sizeof(complex double),ct.gpu_Grow,ione, G_row_host, ione);
...
//   for non gamma point, calculate Grow separately.
    ...
    getvector_device_host (ncopy, sizeof(complex double),ct.gpu_Gcol,ione, G_col_host, ione);
