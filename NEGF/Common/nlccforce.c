 ...
 **    $Id: nlccforce.c 1242 2011-02-02 18:55:23Z luw $    **
******************************************************************************/
...
void nlccforce (REAL * rho, REAL * vxc)
{
    ...
    /*shuchun wang */
    my_malloc_init( pvec, FP0_BASIS, int );
    ...
    for (ion = 0; ion < ct.num_ions; ion++)
    {
        ...
        if (sp->nlccflag)
        {
            ...
            get_start (L0_LDIM, ct.ions[ion].crds[0], ct.xcstart, hxgrid,
                       &ixstart, &iptr->lxcstart);
            get_start (L0_LDIM, ct.ions[ion].crds[1], ct.ycstart, hygrid,
                       &iystart, &iptr->lycstart);
            get_start (L0_LDIM, ct.ions[ion].crds[2], ct.zcstart, hzgrid,
                       &izstart, &iptr->lzcstart);
