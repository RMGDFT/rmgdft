 ...
 */
    ...
    std::complex<double> *Gii, *G_tem, *G_col, *temp, *Hlower, *Hupper, *Gii0;
    std::complex<double> *Gii_host, *G_tem_host, *G_col_host, *temp_host;
    ...
    temp_host = (std::complex<double> *) malloc(n_alloc);

    n_alloc = ntot_row * maxcol * sizeof(std::complex<double>);
    G_tem_host = (std::complex<double> *) malloc(n_alloc);

    n_alloc = ntot_col * maxrow * sizeof(std::complex<double>);
    G_col_host = (std::complex<double> *) malloc(n_alloc);
