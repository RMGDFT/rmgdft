 ...
 **    $Id: partial_QI.c 1242 2011-02-02 18:55:23Z luw $    **
******************************************************************************/
                ...
                if (dvec[idx])
                {
                    ...
                    for (i = 0; i < nh; i++)
                    {
                        ...
                        for (j = i; j < nh; j++)
                        {
                            ...
                            qval_R(i, j, r, cx, qnmlig_tpr, drqnmlig_tpr,
                                   invdr, nhtol, nhtom, indv, ylm, ylm_x,
                                   ylm_y, ylm_z, ap, lpx, lpl, &QI_x[idx1],
                                   &QI_y[idx1], &QI_z[idx1], sp);
                            ++num;
