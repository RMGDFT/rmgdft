 ...
 **    $Id: get_Hij.c 1242 2011-02-02 18:55:23Z luw $    **
******************************************************************************/
...
void get_Hij (STATE * states, STATE * states1, double *vtot_c, double *Aij)
{
 ...
 */
        ...
        {
            states1[st1].psiR[idx] = 0.5 * (states1[st1].psiR[idx] - orbit_tem[idx]);
