 ...
 **    $Id: distribute_to_global2.c 834 2007-08-07 17:32:44Z luw $    **
******************************************************************************/

/*

In case of Fine grid, this routine helps to move data 
from the distributed array FPX0_GRID * FPY0_GRID * FPZ0_GRID
to the global array FNX_GRID * FNY_GRID * FNZ_GRID 
...
void distribute_to_global2 (REAL * distr_array, REAL * global_array)
{
