...
/*===================================================================*/
        ...
        for (iene = pmo.myblacs; iene < E_POINTS; iene += pmo.npe_energy)
        {
            ...
            for (i = 0; i < ntot; i++)
            {
                H_tri[i] = std::real(ene) * lcr[0].Stri[i] - lcr[0].Htri[i] * Ha_eV;
            }
