...
void read_potrho (double *vh, int iflag, char *file_ex)
{
    ...
    if(pct.gridpe ==0) rmg::printlog (" hx_new, hy_new  =  %f  %f \n", hx_new, hy_new); 
...
/* =========== Allocate memory & Reading ON2 data ================ */
    ...
    for(subsystem = 0; subsystem < cei.num_subsystem; subsystem++)
    {
        ...
        /*if(pct.gridpe ==0) rmg::printlog (" x0, y0, z0 = %d %d %d %d \n", subsystem, x0, y0, z0 );*/


        x1 = lcr[subsystem].x1 * get_FG_RATIO();
        y1 = lcr[subsystem].y1 * get_FG_RATIO();
        /*z1 = lcr[subsystem].z1 * get_FG_RATIO();
          if(pct.gridpe ==0) rmg::printlog (" x1, y1, z1 = %d %d %d %d \n", subsystem, x1, y1, z1 );*/


        x2 = lcr[subsystem].x2 * get_FG_RATIO();
        y2 = lcr[subsystem].y2 * get_FG_RATIO();
        /*if(pct.gridpe ==0) rmg::printlog (" x2, y2, z2 = %d %d %d %d \n", subsystem, x2, y2, z2 );*/

        x3 = x2 + x1 - x0;
        y3 = y2 + y1 - y0;
        /*z3 = z2 + z1 - z0;
          if(pct.gridpe ==0) rmg::printlog (" x3, y3, z3 = %d %d %d %d \n", subsystem, x3, y3, z3 );*/
        ...
        /*if(pct.gridpe ==0) rmg::printlog (" x0_old, hx_old = %d %f %f \n", subsystem, x0_old, hx_old);*/
        ...
        /*if(pct.gridpe ==0) rmg::printlog (" y0_old, hy_old = %d %f %f \n", subsystem, y0_old, hy_old);*/
    ...
    /*if(pct.gridpe ==0) rmg::printlog (" Potential patching is done...  \n" );*/
    ...
    /*if(pct.gridpe ==0) rmg::printlog (" x-interpolation is done \n" );*/
    ...
    if(cei.num_probe >= 3)
    {
        ...
        /*if(pct.gridpe ==0) rmg::printlog (" y-interpolation is done \n" );*/
