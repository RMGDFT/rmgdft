...
void rho_munu (complex double * rho_mn_host, complex double * G_row_host, 
        complex double *G_col_host, complex double * gamma_host, int iprobe)
{

    double complex one = 1.0, zero=0.0, half=0.5;
    double complex *temp_host;
    double complex *Grow, *Gcol, *gamma, *temp, *rho_mn;
    ...
    n1 = maxrow * maxcol;
    my_malloc_init( temp_host, n1, complex double );
    ...
    n1 = nL * nL;
    setvector_host_device (n1, sizeof(complex double), gamma_host, ione, ct.gpu_Gii, ione);
    ...
    getvector_device_host(pmo.ntot, sizeof( complex double ), ct.gpu_Gtri, ione, rho_mn_host, ione );
