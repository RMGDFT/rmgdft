 ...
 **    $Id: app10_del2.c 1242 2011-02-02 18:55:23Z luw $    **
******************************************************************************/
...
void app10_del2 (REAL * f, REAL * work, int dimx, int dimy, int dimz, REAL hxgrid, REAL hygrid,
                 REAL hzgrid)
{
        ...
        for (iy = 4; iy < dimy + 4; iy++)
        {
            ...
            for (iz = 4; iz < dimz + 4; iz++)
            {
                ...
                work[(ix - 4) * ix1 + (iy - 4) * iy1 + iz - 4] =
                    t0 * dum2[ix * ixs + iy * iys + iz] + t1x * dum2[(ix - 1) * ixs + iy * iys +
                                                                     iz] + t1x * dum2[(ix +
                                                                                       1) * ixs +
                                                                                      iy * iys +
                                                                                      iz] +
                    t1y * dum2[ix * ixs + (iy - 1) * iys + iz] + t1y * dum2[ix * ixs +
                                                                            (iy + 1) * iys + iz] +
                    t1z * dum2[ix * ixs + iy * iys + iz - 1] + t1z * dum2[ix * ixs + iy * iys + iz +
                                                                          1] + t2x * dum2[(ix -
                                                                                           2) *
                                                                                          ixs +
                                                                                          iy * iys +
                                                                                          iz] +
                    t2x * dum2[(ix + 2) * ixs + iy * iys + iz] + t2y * dum2[ix * ixs +
                                                                            (iy - 2) * iys + iz] +
                    t2y * dum2[ix * ixs + (iy + 2) * iys + iz] + t2z * dum2[ix * ixs + iy * iys +
                                                                            iz - 2] +
                    t2z * dum2[ix * ixs + iy * iys + iz + 2] + t3x * dum2[(ix - 3) * ixs +
                                                                          iy * iys + iz] +
                    t3x * dum2[(ix + 3) * ixs + iy * iys + iz] + t3y * dum2[ix * ixs +
                                                                            (iy - 3) * iys + iz] +
                    t3y * dum2[ix * ixs + (iy + 3) * iys + iz] + t3z * dum2[ix * ixs + iy * iys +
                                                                            iz - 3] +
                    t3z * dum2[ix * ixs + iy * iys + iz + 3] + t4x * dum2[(ix - 4) * ixs +
                                                                          iy * iys + iz] +
                    t4x * dum2[(ix + 4) * ixs + iy * iys + iz] + t4y * dum2[ix * ixs +
                                                                            (iy - 4) * iys + iz] +
                    t4y * dum2[ix * ixs + (iy + 4) * iys + iz] + t4z * dum2[ix * ixs + iy * iys +
                                                                            iz - 4] +
