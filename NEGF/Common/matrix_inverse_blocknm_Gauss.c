...
void matrix_inverse_blocknm_Gauss (complex double * H_tri_host, complex double *G_tri_host, 
 ...
 */
    ...
    getvector_device_host (ncopy, sizeof(complex double),ct.gpu_Gii,ione, Green_C_host, ione);
