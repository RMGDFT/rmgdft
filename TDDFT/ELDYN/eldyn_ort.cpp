...
void eldyn_ort(int *desca, int Mdim, int Ndim, std::complex<double> *Omega,std::complex<double> *Po0,std::complex<double> *Po1,int *p_Ieldyn, double *p_thrs, int *p_maxiter,  double
*p_errmax, int *p_niter, int*p_iprint, MPI_Comm comm) 
{
    /*
       Omega  [in]  : 
    ...
    if (Ieldyn != 1 )       {
        rmg::error("TDDFT only support tCommutp case ");
    }
