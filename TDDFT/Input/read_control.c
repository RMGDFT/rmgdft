...
static void read_orbitals ()
{
    ...
    ns = 0;
    ist = 0;
    ct.num_orbital_center = 0;
    ct.max_orbital_samecenter = 0;
    while (get_data ("orbitals", tbuf, ITEM | STR, NULL))
    {
        ...
        num_orbital_samecenter[ct.num_orbital_center] = num_tem;
        first_orbital_samecenter[ct.num_orbital_center] = ni;
        ct.max_orbital_samecenter = max(ct.max_orbital_samecenter, num_tem);

        ni += num_tem;
        ct.num_orbital_center++;
