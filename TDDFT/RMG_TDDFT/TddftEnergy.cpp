...
template void TddftEnergyInit<double> ( spinobj<double> &vxc,
...
template void TddftEnergyInit<std::complex<double>> ( spinobj<double> &vxc,
        fgobj<double> &vh, fgobj<double> &vnuc,
        spinobj<double> &rho_ground,
        fgobj<double> &rhocore, fgobj<double> &rhoc, 
...
template void TddftEnergy<double, double> ( fgobj<double> &vh, spinobj<double> &rho,fgobj<double> &rhoc,
        Kpoint<double> **Kptr, int Mdim, int Ndim, std::vector<double> &Eterms, MPI_Comm mat_comm);
template void TddftEnergy<double, std::complex<double>> ( fgobj<double> &vh, spinobj<double> &rho,fgobj<double> &rhoc,
        Kpoint<double> **Kptr, int Mdim, int Ndim, std::vector<double> &Eterms, MPI_Comm mat_comm);
template void TddftEnergy<std::complex<double>, std::complex<double>> ( fgobj<double> &vh, spinobj<double> &rho,fgobj<double> &rhoc,
        Kpoint<std::complex<double>> **Kptr, int Mdim, int Ndim, std::vector<double> &Eterms, MPI_Comm mat_comm);
