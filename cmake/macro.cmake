...
FUNCTION(RMG_RUN_ENERGY_CHECK TESTNAME TEST_DIR RMG_EXE PROCS)
   ...
   # message(${RMG_CPU})
    ...
    SET_TESTS_PROPERTIES( ${TESTNAME}_check_total_energy PROPERTIES 
...
FUNCTION(RMG_RUN_NEGF_CHECK TESTNAME TEST_DIR RMG_ON RMG_NEGF PROCS)
   # message("${CMAKE_CURRENT_BINARY_DIR}" )

   SET(CHECK_NEGF_COND "${CMAKE_SOURCE_DIR}/tests/check_negf_cond.py")
   # message(${RMG_CPU})
    ...
    -DRMG_NEGF=${RMG_NEGF}
    -DPROCS=${PROCS}
    -DCHECK_COND=${CHECK_NEGF_COND}
    -P ${CMAKE_SOURCE_DIR}/cmake/negftest.cmake)

SET_TESTS_PROPERTIES( ${TESTNAME} PROPERTIES PASS_REGULAR_EXPRESSION "pass")
    
ENDFUNCTION()

FUNCTION(RMG_RUN_TDDFT_CHECK TESTNAME TEST_DIR RMG_EXE PROCS)
   # message("${CMAKE_CURRENT_BINARY_DIR}" )

   SET(CHECK_TDDFT "${CMAKE_SOURCE_DIR}/tests/RMG_TDDFT/check_tddft.py")
   # message(${RMG_CPU})
    ...
    -DRMG_EXE=${RMG_EXE}
    -DPROCS=${PROCS}
    -DCHECK_TDDFT=${CHECK_TDDFT}
    -P ${CMAKE_SOURCE_DIR}/cmake/tddfttest.cmake)
