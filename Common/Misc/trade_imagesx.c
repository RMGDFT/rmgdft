 ...
 **    $Id: trade_imagesx.c 1134 2010-08-18 08:40:51Z miro $    **
******************************************************************************/
...
void trade_imagesx (REAL * f, REAL * w, int dimx, int dimy, int dimz, int images)
{
    ...
    MPI_Sendrecv (frdz1, zlen, MPI_DOUBLE, nb_ids[NB_D], 1,
                  frdz2n, zlen, MPI_DOUBLE, nb_ids[NB_U], 1, pct.thisgrp_comm, &mrstatus);

    MPI_Sendrecv (frdz2, zlen, MPI_DOUBLE, nb_ids[NB_U], 2,
                  frdz1n, zlen, MPI_DOUBLE, nb_ids[NB_D], 2, pct.thisgrp_comm, &mrstatus);
    ...
    MPI_Sendrecv (frdy1, ylen, MPI_DOUBLE, nb_ids[NB_S], 1,
                  frdy2n, ylen, MPI_DOUBLE, nb_ids[NB_N], 1, pct.thisgrp_comm, &mrstatus);

    MPI_Sendrecv (frdy2, ylen, MPI_DOUBLE, nb_ids[NB_N], 2,
                  frdy1n, ylen, MPI_DOUBLE, nb_ids[NB_S], 2, pct.thisgrp_comm, &mrstatus);
    ...
    MPI_Sendrecv (frdx1, xlen, MPI_DOUBLE, nb_ids[NB_W], 1,
                  frdx2n, xlen, MPI_DOUBLE, nb_ids[NB_E], 1, pct.thisgrp_comm, &mrstatus);

    MPI_Sendrecv (frdx2, xlen, MPI_DOUBLE, nb_ids[NB_E], 2,
                  frdx1n, xlen, MPI_DOUBLE, nb_ids[NB_W], 2, pct.thisgrp_comm, &mrstatus);
